      ...
      <div className="grid md:grid-cols-2 gap-6">
        ...
        <div className="bg-rose-50 p-6 rounded-3xl border border-rose-100 shadow-sm">
          ...
          <div className="flex gap-2">
            <button type="button" onClick={(e) => { e.preventDefault(); e.stopPropagation(); onNavigate && onNavigate('support'); }} className="flex-1 bg-white border border-rose-200 text-rose-600 py-2 rounded-xl text-sm font-bold hover:bg-rose-100 transition-colors flex items-center justify-center gap-2 relative z-10 active:scale-95">
              <PhoneCall className="w-4 h-4 pointer-events-none"/> Trucar Suport
            </button>
            <button type="button" onClick={(e) => { e.preventDefault(); e.stopPropagation(); onNavigate && onNavigate('crisis'); }} className="flex-1 bg-white border border-rose-200 text-rose-600 py-2 rounded-xl text-sm font-bold hover:bg-rose-100 transition-colors flex items-center justify-center gap-2 relative z-10 active:scale-95">
              <CloudLightning className="w-4 h-4 pointer-events-none"/> Pla de Crisi
            </button>
          </div>
        </div>
