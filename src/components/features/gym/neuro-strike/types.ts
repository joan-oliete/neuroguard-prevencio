...
export interface NoteData {
    ...
    // NeuroGuard Additions
    riskType?: 'gambling' | 'screens' | 'gaming' | 'shopping' | 'porn'; // To customize the icon/texture
}
...
export const COLORS = {
    left: '#ef4444',  // Red-ish for Left hand
    right: '#3b82f6', // Blue-ish for Right hand
    track: '#0f172a', // Slate-900 for track background
    grid: '#1e293b',  // Slate-800 for grid lines
    hittable: '#ffffff'
};
